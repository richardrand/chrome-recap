...
var RECAP_PATH = "";
var RECAP_SKIN_PATH = "skin/";

var ICON_LOGGED_IN = "skin/recap-icon.png";
var ICON_LOGGED_IN_32 = "skin/recap-icon-32.png";
var ICON_LOGGED_OUT = "skin/recap-icon-grey.png";
var ICON_LOGGED_OUT_32 = "skin/recap-icon-grey-32.png";
var ICON_DISABLED = "skin/recap-icon-disabled.png";
var ICON_DISABLED_32 = "skin/recap-icon-disabled-32.png";
var ICON_EXCLAMATION = "skin/recap-icon-exclamation.png";
var ICON_EXCLAMATION_32 = "skin/recap-icon-exclamation-32.png";

var SERVER_URL = "http://" + localStorage['recap_server'] + "/recap/";
...
var DEBUG_PACER_DOMAIN = "dcecf.psc.uscourts.gov";
...
function isPACERHost(hostname) {
    return ((PACER_DOMAINS.indexOf(hostname) >= 0) || ((localStorage["debugging"] == "true" || debugging == true) && hostname == DEBUG_PACER_DOMAIN)) ? true : false;
}
...
function showAlert(icon, headline, message) {
    chrome.extension.sendMessage({showAlert: {icon: icon, headline: headline, message: message}});
}
...
function updateMetaCache(metacache, documents, cases){
	...
	for (var caseid in cases) {
		...
		officialcasenum = cases[caseid]["officialcasenum"];
